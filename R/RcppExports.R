...
buildMarkov <- function(nbsp, colo, metaweb, basexti, mn, mx, shape) {
    .Call("biogeonet_buildMarkov", PACKAGE = "biogeonet", nbsp, colo, metaweb, basexti, 
        mn, mx, shape)
}
...
colonization <- function(envir, maxcolo, opti, width) {
    .Call("biogeonet_colonization", PACKAGE = "biogeonet", envir, maxcolo, opti, 
        width)
}
...
extinction <- function(inter, basexti, mn, mx, shape) {
    .Call("biogeonet_extinction", PACKAGE = "biogeonet", inter, basexti, mn, mx, 
        shape)
}
...
solveMarkov <- function(markov) {
    .Call("biogeonet_solveMarkov", PACKAGE = "biogeonet", markov)
}
...
solveSparseMarkov <- function(smarkov) {
    .Call("biogeonet_solveSparseMarkov", PACKAGE = "biogeonet", smarkov)
}
